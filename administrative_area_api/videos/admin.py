...
from videos.forms import VideoChunkFinishUploadForm, VideoChunkUploadForm
...
class VideoAdmin(admin.ModelAdmin):
    ...
    def redirect_to_upload(self, obj: Video):
        url = reverse("admin:videos_video_upload", args=[obj.id])
    ...
    def upload_video_view(self, request, id):
        ...
        try:
            ...
            return render(request, "admin/upload_video.html", context)
